...
def XNOR(x, y):
    return NAND( NAND(NAND(NAND(x, y),y), NAND(x,NAND(x, y))) , NAND(NAND(NAND(x, y),y), NAND(x,NAND(x, y))) )
...
print('XNOR(1, 1)=' + str(XOR(1, 1)) + ' XNOR(1, 0)=' + str(XOR(1, 0)) + ' XNOR(0, 0)=' + str(XOR(0, 0)))
